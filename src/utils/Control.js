/*
 * FileName: Control.js ( Copied from a blog )
 * Author: Stella Laurenzo 
 * Date: August 12th, 2012
 * Time: 2:45 PM
 * Description: Centralizing of exception handling using Ruby's Block/Rescue style programming.
 */
...
Block.errorHandler=function() {
	...
	console.log( "Raja Block Error Handler " +  current);
